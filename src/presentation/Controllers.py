...
from bussiness.Bagging import Bagging
...
class AppController(object):
    ...
    def __init__(self):
        ...
        self.classifier_caldas = Bagging('Caldas')
        self.classifier_adni = Bagging('ADNI')
        self.loadCaldas()
        self.loadADNI()
    ...
    def save(self):
        """
        Saves the bagging models if they are already trained.
    ...
    def loadCaldas(self):
        """
        Loads the bagging models for Caldas database if they're persisted in path_caldas
    ...
    def loadADNI(self):
        """
        Loads the bagging models for ADNI database if they're persisted in path_adni
