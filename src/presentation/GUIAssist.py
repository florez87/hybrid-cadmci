...
class Ui_GUIAssist(object):
    ...
    def trainSystem(self):
        """
        Orders the AppController to train a bagging classifier based on the selected database.
    ...
    def validateSystem(self):
        """
        Orders the AppController to validate a bagging classifier based on the selected database.
